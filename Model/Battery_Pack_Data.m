%% Parameters for Battery Pack Model
% 
...
%Ts   = 1;   % Sample time (s)
%% Kalman Filter
Qsoc    = [1e-4 0; 0 1e-4]; % Covariance of the process noise, Q
Rsoc    = 0.7;              % Covariance of the measurement noise, R
P0soc   = [1e-5 0; 0 1];    % Initial state error covariance, P0
